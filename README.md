...
2. Set up a custom micromamba environment for modulator: `micromamba create -y -n modulator_run -c conda-forge -c bioconda python=3.11 snakemake=8.*` 
3. Activate the environment: `micromamba activate modulator_run`
