...
2. Set up a custom micromamba environment for modulator:
`
micromamba create -y -n modulator -c conda-forge -c bioconda \
  python=3.13.7 pandas=2.3.3 numpy=2.3.3 matplotlib=3.10.6 \
  pysam=0.23.3 samtools=1.22.1 scipy
