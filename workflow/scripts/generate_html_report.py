...
COLUMN_DEFINITIONS = {
    ...
    "strata_heterogeneity_p_adj": "Benjamini-Hochberg FDR-adjusted strata_heterogeneity_p across all tested rows (a raw p<0.05 would flag ~5% of perfectly homogeneous rows). strata_heterogeneous is this < 0.05.",
